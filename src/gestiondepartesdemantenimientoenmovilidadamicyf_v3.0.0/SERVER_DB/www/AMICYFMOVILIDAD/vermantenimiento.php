<?php
   ...
   $importeHoras = obtenerCosteHoras($numHoras,$filaPreventivo['idPerfil']);
   $importeKm=obtenerCosteKilometros($numKilometros,$filaPreventivo['idKilometraje']);
...
<table width="230px" border="0" cellpadding="0" cellspacing="0" class="contenedor"><form action="vermantenimiento.php" method="post">
  <tr>
...
<!--  <tr>
    <td><span class="texto1">T&eacute;cnico:<br />
    </span></td>
    <td><select name="select3" class="textarea">
      <option>Elija un valor</option>
    </select>    </td>
  </tr>
  <tr>
    <td><span class="texto1">Descuento:<br />
    </span></td>
    <td><input name="descuento" type="text" class="textarea" id="descuento" size="10" maxlength="30" />
      <span class="texto1">      &euro; </span></td>
  </tr>
  <tr>
    <td><span class="texto1">Total:<br />
    </span></td>
    <td><input name="total" type="text" class="textarea" id="total" size="10" maxlength="30" /> 
      <span class="texto1">&euro; </span></td>
  </tr>
 -->
  <tr>
  ...
  <tr>
    <td colspan="3" class="botones"><input type="submit" class="botones" name="modificar" value="Modificar" />
