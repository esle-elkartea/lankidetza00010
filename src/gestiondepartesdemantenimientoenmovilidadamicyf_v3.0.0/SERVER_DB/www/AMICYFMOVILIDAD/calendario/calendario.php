...
function mostrar_calendario($mes,$ano){
	...
	echo "<table width=165 cellspacing=3 cellpadding=2 border=0><tr><td colspan=7 align=center class=tit>";
	echo "<table width='100%' cellspacing=2 cellpadding=2 border=0><tr><td style=font-size:10pt >";
	...
	echo "<a  href='".aHttps("planificador.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior")."'>&lt;&lt;</a></td>";
	...
	echo "<a href='".aHttps("planificador.php?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente")."'>&gt;&gt;</a></td></tr></table></td></tr>";
	echo "	<tr>
...
--> 
	...
	<a  href="javascript:void(0)" onClick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')"><img src="calendario/icono_calendario.gif" alt="Pulsa encima para seleccionar la fecha" border="0"></a>
	';
	//<input type=button value="Seleccionar fecha" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">	
}

function escribe_formulario_fecha_valor($nombrecampo,$nombreformulario,$valor){
	global $raiz;
	echo '
