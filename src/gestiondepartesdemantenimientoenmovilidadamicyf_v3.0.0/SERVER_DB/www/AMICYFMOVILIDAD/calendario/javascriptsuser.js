...
function muestraVentana(raiz,formulario_destino,campo_destino,idEmp){
	...
	ventanaVentana = window.open("calendario/asigUser.php?idEmp="+idEmp+"&formulario=" + formulario_destino + "&nomcampo=" + campo_destino,"calendario","width=200,height=200,left=0,top=0,scrollbars=no,menubars=no,statusbar=NO,status=NO,resizable=YES,location=NO")
}
