...
<script language="javascript" src="<%=alias%>/js/perfil/comun.js" type="text/javascript"></script>
<script language="javaScript" type="text/javascript">

function enviar(){
	document.formulario.target = '_top';
	document.formulario.action = "PerfilProcesarServlet";
...
<div class="main">
	<div class="activoIn">
		<div class="activoSupIn">
			<div class="tituloIn">
				<div class="tituloInPos">Modificación de Perfil</div>
			</div>
			<div class="TextoIn">
				<form action="" method="post" name="formulario">

					<%@include file="inc/PerfilForm.jsp"%>
					<div class="altas11">
